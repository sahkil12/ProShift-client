    ...
    return (
        <section className="py-7">
            <div className="w-full md:w-11/12 mx-auto px-4">
                <h2 className="text-3xl sm:text-4xl font-extrabold mb-9 md:mb-12 text-teal-900">How It Works</h2>
                <div  className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-7">
                    {howItWorksData.map((card, index) => (
                        <div key={index}
                            className={`how-card border border-neutral-200 card px-6 py-12 shadow-md bg-white rounded-2xl hover:shadow-xl transform duration-300 transition-transform hover:-translate-y-1.5`}>
                            <div className="mb-5">
                                {card.icon}
                            </div>
